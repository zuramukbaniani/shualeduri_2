...
@section('content')
    <div class="container">
        ...
        <div style="display:inline-block">
            <a href="{{ route('UserShowWithTeam', ['id'=>$team->id]) }}" class="btn btn-default">{{ $team->team }}</a>
        </div>
        @endforeach
        @foreach($news as $new)
        <div class="container">
        ...
        <div class="row no-gutters">
            <div class="col-md-4">
            <img src="{{ asset('images'."/".$new->image) }}" alt="" style="with:80px; height:80px" class="img-circle">
            </div>
            <div class="col-md-8">
            <div class="card-body">
